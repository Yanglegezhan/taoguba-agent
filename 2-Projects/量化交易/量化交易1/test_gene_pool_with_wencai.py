...
sys.path.insert(0, os.path.join(project_dir, "Ashare复盘multi-agents", "next_day_expectation_agent", "src"))

def test_wencai_hot_stocks():
    """测试使用 wencai 获取热门股"""
    print("=" * 60)
    print("测试: 基因池构建器使用 wencai 获取热门股")
    print("=" * 60)
...
def main():
    """运行所有测试"""
    print("开始测试基因池构建器 + wencai 集成\n")
    
    success1 = test_wencai_hot_stocks()
